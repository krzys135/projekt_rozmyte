...
public class PojemnoscBagaznika extends Cecha{
	
	private static int max =2650;
	public static int bd = 550;
	public static int d = 400;
	public static int m = 300;
	public static int bm = 250;
	private static int min = 130;
	public static final int numer = 2;
	//(double)
	public PojemnoscBagaznika(int stopien){
            super(stopien);
	}
