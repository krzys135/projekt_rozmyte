...
public class Cena extends Cecha{
	
	private static int max = 452743;
	public static int bd = 2500000;
	public static int d = 150000;
	public static int m = 100000;
	public static int bm = 50000;
	private static int min = 17800;
	public static int numer = 5;
	
	public Cena(int stopien){
            super(stopien);
	}
